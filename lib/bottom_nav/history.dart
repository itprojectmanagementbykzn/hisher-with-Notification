...
Future fetchWpPosts() async {
  final response = await http.get(Uri.parse(
    "https://hisandhermyanmar-95b62f.ingress-erytho.easywp.com/index.php/wp-json/wp/v2/posts?per_page=100&categories=294&orderby=date&status=publish",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        ...
        child: FutureBuilder(
          future: Provider.of<BlogProvider>(context, listen: true).historyBlogPosts,
